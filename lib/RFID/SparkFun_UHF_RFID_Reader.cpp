...
void RFID::sendCommand(uint16_t timeOut, boolean waitForResponse)
{
  ...
  unsigned long elapsed1 = end1 - start;
  ...
  unsigned long elapsed2 = end2 - end1;
  ...
  unsigned long elapsed3 = end3 - end2;
  Serial.print("elapsed3: ");
  Serial.println(elapsed3);
  //Check CRC
  // crc = CheckSum(&msg[0], messageLength + 3);
