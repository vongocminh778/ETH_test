...
public:
	...
	virtual void InsertColumn(int nCol, LPCTSTR lpszColumnHeading, int nFormat /* = LVCFMT_LEFT */, int nWidth /* = -1 */, int nSubItem = -1/* = -1 */);
	virtual void InsertItem(int nItem, LPCTSTR lpszItem, int nImage);
	virtual void InsertItem(int nItem, LPCTSTR lpszItem);
protected:
